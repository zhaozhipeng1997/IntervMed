...
class Causalllava15:
    ...
    def generate(self, image: Image.Image, prompt: str, config: dict) -> str:
        ...
        prompt1 = processor.apply_chat_template(conversation, add_generation_prompt=True)
        inputs = processor(images=image, text=prompt1, return_tensors="pt").to("cuda:0")
...
if __name__ == "__main__":
    ...
    with open("utils/generation_config.yaml", "r") as f:
            ...
            model_path = paths["model_paths"]["llava_next_13b"]
